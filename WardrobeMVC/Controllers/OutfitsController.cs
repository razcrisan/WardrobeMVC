...
namespace WardrobeMVC.Controllers
{
    public class OutfitsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OutfitID,AccessoryID,TopID,BottomID,ShoeID")] Outfit outfit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OutfitID,AccessoryID,TopID,BottomID,ShoeID")] Outfit outfit)
        {
            if (ModelState.IsValid)
            {

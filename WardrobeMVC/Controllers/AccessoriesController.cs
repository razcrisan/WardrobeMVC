...
namespace WardrobeMVC.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,Name,Photo,Type,Color,Occasion")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,Name,Photo,Type,Color,Occasion")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {

...
namespace WardrobeMVC.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,Name,Photo,Type,Color,Occasion")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,Name,Photo,Type,Color,Occasion")] Top top)
        {
            if (ModelState.IsValid)
            {
